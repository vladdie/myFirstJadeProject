/*****************************************************************
  ...
  Test:  % java jade.Boot main:Template a1:Responder a2:Responder
    -gui -agents main:Template;a1:Responder;a2:Responder
*****************************************************************/
    ...
    MessageTemplate mt1 = 
       MessageTemplate.and(  
           ...
           MessageTemplate.MatchSender( new AID( "a1", 
                                                 AID.ISLOCALNAME))) ;
//set up 2 behaviours, each coded to receive messages 
//first will use with a template for INFORM message from agent a1
//second will accept any kind of message
